...
if isempty(varargin)
  ...
  datasetinfo.projname='u5577/LOS';
  datasetinfo.projname='u6300/LOS';
  ...
  %datasetinfo.paralist={'u55_N','u55_E','u55_h',  ...
  %  'u55_bm1','u55_bm2','u55_bm3','u55_bm4','u55_bm5'};
...
function [datelist]=getdatelist(id)
  ...
  if id==0
    ...
    ed_dn=datenum(dv);
  elseif id==1
    st_dn=datenum([2011 12 17 16 00 00]);
    ed_dn=datenum([2011 12 18 02 00 00]);
  elseif id==2
