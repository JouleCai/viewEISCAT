...
%    'u63_bm1','u63_bm2','u63_bm3','u63_bm4','u63_bm5'};
  datasetinfo.paralist={'u63_N','u63_E','u63_h','a63_N','a63_E',    ...
                        'u55_N','u55_E','u55_h','a55_N','a55_E'};
  datasetinfo.save=0; % 0 - no save; 1 - save
  
  % Set plotting pannels
  %drawopt.order={[2,-2],10,[2,-2],5};
  drawopt.order={[7,-7],10,[2,-2],5};
